...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initHour)\n/* harmony export */ });\nfunction initHour() {\n  var date = new Date();\n  var horaAgora = date.getHours();\n  var diaAgora = date.getDay();\n  var icon = document.querySelector('[data-funcionamento]');\n  var dias = icon.dataset.dias.split(',').map(Number);\n  var hora = icon.dataset.horario.split(',').map(Number);\n  var hasDia = dias.indexOf(diaAgora) !== -1;\n  var hasHour = horaAgora >= hora[0] && horaAgora < hora[1];\n  if (hasDia && hasHour) {\n    icon.classList.add('aberto');\n  } else {\n    icon.classList.remove('aberto');\n  }\n}\n\n//# sourceURL=webpack://animais-eslint/./js/modules/horario.js?");
